      ...
      <section className={styles.rightSide}>
        <div className={styles.aboutMe}>
          ...
          <div className={styles.aboutMe__content}>
            <p>
              23 года, нахожусь в Москве. Занимаюсь веб-разработкой с октября
              2018 года. Люблю в этой профессии чувство создания чего-то нового,
              возможность созерцать красоту огромного механизма, который
              отлаженно работает, несмотря на свою сложность.
            </p>
